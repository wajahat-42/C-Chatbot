...
High Performance: C++ backend powered by the Crow web framework.
...
✍️ Usage
Enter Premises: Input your premises in the textarea, one per line.

Define Conclusion: Input the target formula.

Prove: Click ▶ Prove Argument.

Analyze: If the argument is valid, the UI will display a step-by-step derivation table showing how the conclusion was reached.
